    ...
    <section>
        <Container>
            <Row>
                ...
                <i class="ri-star-fill " style={{'color': 'var(--secondary-color)'}}></i> {calculateAvgRating === 0 ? null : avgRating} {totalRating === 0 ? 'Not rated' : <span>({reviews?.length})</span>} 
                </span>
                ...
                <span>
                    <i class="ri-map-pin-user-fill"></i> {address}
                        ...
                        <div className="tour__reviews mt-4">
                            ...
                            <Form>
                                <div className='d-flex align_items-center gap-3 mb-4 rating__group'>
